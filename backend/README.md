...
## Project Structure
    ...
    ├── ridesharing_fe_base_40370  # Django project configurations
...
1. Clone this repo and `cd ridesharing_fe_base_40370`
...
2. Clone this repo and `cd ridesharing_fe_base_40370`
